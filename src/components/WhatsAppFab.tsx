...
// Floating click-to-chat button shown on every page (in the root layout).
export function WhatsAppFab() {
  return (
    <a
      ...
      className="fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full shadow-lg shadow-black/20 transition-transform hover:scale-105"
